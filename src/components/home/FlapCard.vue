...
export default {
  ...
  methods: {
    ...
    flapCardRotate () {
      ...
      const backFlapCark = this.flapCardList[this.back]
      frontFlapCard.rotateDegree += 10
      frontFlapCard._g -= 5
      backFlapCark.rotateDegree -= 10
      backFlapCark._g += 5
      if (frontFlapCard.rotateDegree === 90 && backFlapCark.rotateDegree === 90) {
        backFlapCark.zIndex += 2
      }
      this.rotate(this.front, 'front')
      this.rotate(this.back, 'back')
      if (frontFlapCard.rotateDegree === 180 && backFlapCark.rotateDegree === 0) {
        this.next()
      }
    },
    next () {
      ...
      backFlapCark.rotateDegree = 0
      frontFlapCard._g = frontFlapCard.g
      backFlapCark._g = backFlapCark.g
      this.rotate(this.front, 'front')
      this.rotate(this.back, 'back')
      this.front++
      this.back++
    ...
    prepare () {
      const backFlapCark = this.flapCardList[this.back]
      backFlapCark.rotateDegree = 180
      backFlapCark._g = backFlapCark.g - 5 * 18
      this.rotate(this.back, 'back')
    },
    reset () {
      this.front = 0
  ...
  created () {
    this.pointList = new Array(18).map((p, i) => `point${i}`)
  }
}
</script>
